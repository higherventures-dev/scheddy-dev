      ...
      {links.map((link) => {
        ...
        return (
          <Link
            key={link.name}
            href={link.href}
            className={clsx('flex h-[40px] grow items-center justify-center gap-2 rounded-md p-3 text-sm text-xs hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-start md:p-2 md:px-3',
              {
